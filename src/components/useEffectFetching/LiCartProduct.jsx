...
export const LiCartProduct = (props) => {
  ...
  return (
    ...
    key={product.index}
    >
      <span className="text-xl text-blue-500 font-medium">{product.titulo}</span>
      <span className=" text-2xl text-green-800 font-semibold">{product.precio}€</span>
